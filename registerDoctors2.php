  ...
  <div class="home-content">
      ...
      <div class="sales-boxes">
        ...
        <div class="recent-sales box">
          <div class="title">Register Doctors</div>
...
<div class="card px-1 py-4"> 
	<form class="card-body" action="registerDoctorsLogic.php" method="post" id="registerUsersForm">
		
		<h1 class="h3 mb-3 font-weight-normal">Register Doctors</h1>
