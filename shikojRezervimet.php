  ...
  <tbody>
    <?php foreach ($datas as $data ):?> 
		<tr>
			...
			<td><?=$data['email']?></td>	
			<!--<td><?=$data['doktorri']?></td>-->
			<td><a id="setingsi" href="medicalHistory.php?id=<?=$data['id'];?>"><iconify-icon  icon="ic:outline-medical-services"></iconify-icon></a></td>
		</tr>
    <?php endforeach; ?>
